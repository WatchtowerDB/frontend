  ...
  return (
    <div className="flex flex-wrap items-center gap-1.5 py-1">
      {visibleChips.map((chip) => (
        ...
        >
          {chip.icon && <chip.icon className="text-muted-foreground h-3.5 w-3.5 shrink-0" />}
          ...
          <button
            ...
            className="text-muted-foreground hover:bg-foreground/10 hover:text-foreground focus-visible:ring-ring -mr-1 ml-0.5 inline-flex h-4 w-4 cursor-pointer items-center justify-center rounded-md p-0 transition-colors outline-none focus-visible:ring-1"
      ...
      {hasOverflow && (
        <button
          ...
          className="text-muted-foreground hover:text-foreground hover:bg-muted border-muted-foreground/20 inline-flex h-5 cursor-pointer items-center rounded-md border border-dashed px-2 py-0.5 font-mono text-[11px] font-semibold tracking-tight transition-all"
        >
